...
<section class="mbr-section form4 cid-qEzk67fHgG" id="form4-i" data-rv-view="30">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="google-map"><iframe frameborder="0" style="border:0" src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0Dx_boXQiwvdz8sJHoYeZNVTdoWONYkU&amp;q=place_id:ChIJN_2UjNQVei4RUPpTD6KBiXI" allowfullscreen=""></iframe></div>
            </div>
            <div class="col-md-6">
